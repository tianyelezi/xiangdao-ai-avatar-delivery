...
class ModelManager:
    def __init__(
        ...
        # Skip startup warm-up for the local desktop deployment.
        # The first synthesis request will initialize any remaining runtime state.
        logger.info("Models loaded; startup warm-up skipped.")
